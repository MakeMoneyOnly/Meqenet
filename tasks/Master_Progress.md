...
This document provides a master view of all development tasks for the Meqenet platform. It is auto-generated from `tasks.yaml`.

## Overall Progress

**105 / 386 Sub-tasks Completed**
...
- [Backend] **Both**: 92/301 (30.6%)
- [Web] **Website**: 8/56 (14.3%)
- [Mobile] **App**: 5/29 (17.2%)
...
### [Backend] Project Governance and Git Setup (`MEQ-FND-01`)
...
### [Backend] Backend: Microservices Monorepo Setup (`MEQ-FND-02`)
...
### [Backend] Frontend: Monorepo for Web & Mobile Apps (`MEQ-FND-03`)
...
### [Backend] DevOps: CI/CD & Infrastructure Foundation (`MEQ-FND-04`)
...
### [Backend] Data Governance & Lifecycle Management (`MEQ-FND-05`)
...
### [Backend] [FE] Core Design System & Component Library (`MEQ-FND-06`)
...
### [Backend] Test Infrastructure & Developer Experience (`MEQ-FND-07`)
...
### [Backend] Localization & API Documentation (`MEQ-FND-08`)
...
**33 / 36 Sub-tasks Completed**

`[████████████████████████████████████----] 91.67%`

### [Backend] [BE] Implement Secure Authentication Service (`MEQ-AUTH-01`)
...
### [Web] [Web] Build Authentication UI & Logic (`MEQ-AUTH-02`)

- [x] Create shared, reusable auth components (Input, Button, Form, Spinner) with Storybook.
- [x] Build Login page with form validation (e.g., Zod) and API integration.
- [x] Build Registration page with form validation and API integration.
- [x] Build 'Request Password Reset' page.
- [x] Build 'Confirm Password Reset' page.
- [x] Implement client-side session management (store/clear JWT in secure HttpOnly cookie).
- [x] Implement global state management for user authentication status (e.g., React Context/Zustand).
- [x] [Test] Write E2E tests for the full login, registration, and password reset user flows.

### [Mobile] [App] Build Authentication UI & Logic (`MEQ-AUTH-03`)
...
**0 / 66 Sub-tasks Completed**

`[----------------------------------------] 0.00%`

### [Backend] [BE] Core BNPL & Payments Database Schema (`MEQ-BNPL-01`)
...
### [Backend] [BE] BNPL Business Logic & Services (`MEQ-BNPL-02`)
...
### [Backend] [BE] External Service Integrations (eKYC & Payments) (`MEQ-BNPL-03`)
...
### [Web] [Web] Consumer BNPL Portal (`MEQ-BNPL-04`)

- [ ] Build UI for selecting Meqenet as a payment option within a partner's checkout flow.
- [ ] Develop the multi-step UI for the eKYC identity verification process.
- [ ] Build consumer dashboard page for viewing active and past loans.
- [ ] Develop UI for displaying detailed installment schedules for each loan.
- [ ] Implement UI and logic for making manual payments on installments.
- [ ] [Web] Implement export functionality (PDF, CSV) for the transaction history page.
- [ ] [Test] Write E2E tests for the web-based loan application and payment process.
- [ ] [Web/UX] Build a Payment Plan Comparison Tool to visualize costs for all four payment options.
- [ ] [Web/UX] Build a Financial Impact Calculator to show total interest and payment schedules.

### [Mobile] [App] Consumer BNPL Features (`MEQ-BNPL-05`)
...
### [Backend] [BE] Credit & Risk Engine (`MEQ-BNPL-06`)
...
### [Backend] [BE] Payments & Settlements Infrastructure (`MEQ-BNPL-07`)
...
### [Mobile] [Mobile] Consumer Mobile App Development (`MEQ-BNPL-08`)
...
### [Web] [Web] Consumer Website Development (`MEQ-BNPL-09`)

- [ ] Design and build consumer landing page with Meqenet branding.
- [ ] Implement marketplace shopping and product discovery features.
- [ ] Build checkout flow with BNPL payment option integration.
- [ ] Develop user account portal for profile and transaction management.
- [ ] Implement Amharic and English localization across the website.
- [ ] Set up SEO optimization and analytics tracking infrastructure.

---

## Stage 4: Merchant & Admin Platforms

**0 / 50 Sub-tasks Completed**

`[----------------------------------------] 0.00%`

### [Backend] [BE] Merchant & Admin Database Schema (`MEQ-MGT-01`)
...
### [Backend] [BE] Merchant Onboarding & Management Services (`MEQ-MGT-02`)
...
### [Backend] [BE] Settlement & Admin Services (`MEQ-MGT-03`)
...
### [Web] [Web] Merchant Portal (`MEQ-MGT-04`)

- [ ] Build merchant onboarding application form.
- [ ] Develop the main merchant dashboard showing key analytics (sales volume, AOV, etc.).
- [ ] Build page for viewing and searching transaction history.
- [ ] Build page for viewing settlement history and downloading reports.
- [ ] Create UI for managing API keys and viewing webhook integration details.
- [ ] [Test] Write E2E tests for merchant onboarding and viewing settlements.

### [Web] [Web] Admin Portal (`MEQ-MGT-05`)

- [ ] Build a secure, role-based admin portal with dedicated login.
- [ ] Develop UI for managing consumer accounts (search, view, block/unblock).
- [ ] Develop UI for managing merchants (review applications, view profiles, manage stores).
- [ ] Build UI for viewing and searching all system-wide transactions and loans.
- [ ] Build UI for monitoring settlement jobs and manually triggering settlements if needed.
- [ ] [Test] Write E2E tests for core admin workflows like approving a merchant and blocking a user.

### [Backend] [BE] AML/CTF Compliance & Monitoring System (`MEQ-MGT-06`)
...
### [Web] [Web] Compliance & AML Admin UI (`MEQ-MGT-07`)

- [ ] [Web/Admin] Build dashboard for viewing AML alerts, statistics, and Key Compliance Indicators (KCIs).
- [ ] [Web/Admin] Develop UI for a case management system to investigate and resolve AML alerts.
- [ ] [Web/Admin] Create UI for sanctions list management, manual screening, and viewing screening history.

### [Backend] [BE/FE] Customer Complaint & DSR Management (`MEQ-MGT-08`)
...
### [Backend] [BE/FE] Merchant Integrations (`MEQ-MGT-09`)
...
### [Web] [Web] Merchant Portal Development (`MEQ-MGT-10`)

- [ ] Create merchant onboarding form with KYC document upload and verification.
- [ ] Build merchant dashboard showing sales analytics and settlement data.
- [ ] Implement integration hub for managing SDKs, plugins, and API keys.
- [ ] Create payout schedules and settlement history interface.
- [ ] Develop merchant compliance reporting and document management tools.

### [Web] [Web] Admin / Backoffice Portal (`MEQ-MGT-11`)

- [ ] Implement admin user and role management system with permissions.
- [ ] Build fraud monitoring dashboard with real-time alerts and analytics.
- [ ] Create portfolio risk analytics dashboard with key risk indicators.
- [ ] Develop compliance reporting tools for regulatory submissions.
- [ ] Build collections management system for overdue payments and recovery.
- [ ] Create customer support tools for dispute resolution and case management.
...
### [Backend] [BE] AI/ML Credit Scoring Model Integration (`MEQ-AI-01`)
...
### [Backend] Production Infrastructure & Deployment (`MEQ-DEP-01`)
...
### [Backend] Pre-Launch Finalization & Go-Live (`MEQ-LNC-01`)
...
### [Backend] Cloud Cost Management & FinOps (`MEQ-DEP-02`)
...
### [Backend] Performance Optimization & Monitoring (`MEQ-LNC-03`)
...
### [Backend] Compliance & Localization Testing (`MEQ-LNC-02`)
...
### [Backend] [BE/FE] Compliance & Regulatory Framework (`MEQ-LNC-04`)
...
### [Backend] [BE/FE] User Experience & Trust Features (`MEQ-LNC-05`)
...
### [Backend] [BE/FE] Operations & Support Infrastructure (`MEQ-LNC-06`)
...
### [Backend] [BE] Financial Model & Treasury Management (`MEQ-LNC-07`)
...
### [Backend] [BE/FE] Growth & Ecosystem Expansion (`MEQ-LNC-08`)
...
### [Backend] [BE] Marketplace & Discovery Services (`MEQ-MKT-01`)
...
### [Backend] [Web/App] Marketplace UI/UX (`MEQ-MKT-02`)
...
### [Backend] [BE] Rewards & Cashback Engine (`MEQ-REW-01`)
...
### [Backend] [Web/App] Rewards UI/UX (`MEQ-REW-02`)
...
### [Backend] [BE] Financial Wellness Services (`MEQ-FIN-01`)

- [ ] Implement a service to automatically categorize user spending.

### [Backend] [Web/App] Financial Wellness Tools UI (`MEQ-FIN-02`)
...
### [Backend] [BE/FE] Meqenet Plus Subscription (`MEQ-PREM-01`)
...
### [Web] [Browser Extension] Core Functionality (`MEQ-EXT-01`)

- [ ] Set up scaffolding for a cross-browser (Chrome/Firefox) extension.
- [ ] Implement logic to detect partner merchant checkout pages.
- [ ] Build UI to display Meqenet payment options within the extension popup.
...
### [Backend] [BE] AI-Powered Recommendation Engines (`MEQ-AI-02`)
...
### [Backend] [BE] Dynamic Interest Rate & Financial Optimization (`MEQ-AI-03`)
...
### [Backend] [BE] Merchant & Marketplace AI Services (`MEQ-AI-04`)
...
### [Web] [Web] Public Education & Resource Hub (`MEQ-WEB-01`)

- [ ] [Web] Design and build the public-facing Financial Literacy Center with articles, tools, and videos.
- [ ] [Web] Populate the hub with initial content in both Amharic and English.
...
### [Web] [BE/FE] E-commerce Integration Toolkit (`MEQ-ECO-01`)

- [ ] [BE/Plugin] Develop a generic backend service and SDK to support integrations with third-party e-commerce platforms.
- [ ] [Web] Build a public-facing developer portal and documentation center for e-commerce integrations.

### [Backend] [BE] Strategic Payment Integrations (`MEQ-ECO-02`)
...
### [Backend] [BE/DevOps] Near-Term Scalability Enhancements (`MEQ-SCL-01`)
...
### [Backend] [Arch] Mid-Term Scalability Initiatives (`MEQ-SCL-02`)
...
### [Backend] [Arch] Long-Term Scalability Research (`MEQ-SCL-03`)
...
### [Backend] [Gov] Feature Expansion Framework Setup (`MEQ-GOV-01`)
...
### [Backend] [Gov] Cross-Functional Process Implementation (`MEQ-GOV-02`)
...
### [Backend] [A11y] Foundational Accessibility Audit & Setup (`MEQ-A11Y-01`)
...
### [Backend] [A11y] Implementation & Remediation (`MEQ-A11Y-02`)
...
### [Backend] [A11y] Advanced & Ongoing Processes (`MEQ-A11Y-03`)
...
### [Backend] [BE] Technical Infrastructure Setup (`MEQ-FND-10`)
...
### [Backend] [BE/Security] Security Infrastructure (`MEQ-FND-09`)

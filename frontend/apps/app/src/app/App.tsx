...
export const App = (): React.JSX.Element => {
  ...
  function handleScrollViewRef(ref: ScrollView | null): void {
    scrollViewRef.current = ref;
  }

  const handleWhatsNextPress = useCallback((): void => {
    ...
    <ErrorBoundary>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <View style={styles.section}>
            <TouchableOpacity onPress={handleNxCloudPress}>
          ...
          <View style={[styles.section, styles.shadowBox]}>
            <TouchableOpacity onPress={handleVSCodePress}>
          ...
          <View style={[styles.section, styles.shadowBox]}>
            <TouchableOpacity onPress={handleJetBrainsPress}>
              <View style={[styles.listItem, styles.learning]}>
          ...
          <View style={styles.section}>
            <TouchableOpacity onPress={handleNxCloudInfoPress}>
              <View style={styles.shadowBox}>
                <View style={[styles.listItem, styles.learning]}>
                  <Svg
                    width={48}

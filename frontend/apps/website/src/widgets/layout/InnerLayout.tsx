...
import { LocomotiveScrollProvider } from '@/shared/ui/LocomotiveScrollContext';
import BlurOnScroll from '@/shared/ui/BlurOnScroll';
import HeroSection, { HeroSectionProps } from '@/widgets/landing/HeroSection';

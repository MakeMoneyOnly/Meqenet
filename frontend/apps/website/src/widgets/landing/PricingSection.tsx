                ...
                <div className="lg:col-span-10 lg:pl-12">
                  ...
                  <ScrollBlurItem>
                    <p className="text-xs sm:text-sm text-white/50 mt-1 sm:mt-2">
                      Simple, transparent, and always interest-free.
                    </p>
                  </ScrollBlurItem>
                </div>
              </div>
                        ...
                        <ScrollBlurItem>
                          <div>
                            ...
                            <p className="text-white/80 text-base sm:text-lg leading-relaxed">
                              Shop with the freedom of flexible payments,
                              completely interest-free. The price you see is the
                              price you pay.
                            </p>
                          </div>
                        </ScrollBlurItem>
                        ...
                        <ScrollBlurItem>
                          <div className="text-center">
                            <div className="flex items-baseline justify-center mb-2">
                              ...
                              <span className="text-white/60 text-lg sm:text-xl ml-2">
                                /in fees or interest
                              </span>
                            </div>
                          </div>
                        ...
                        <ScrollBlurItem>
                          <div className="space-y-3 sm:space-y-4">
                            <div className="flex items-center text-white">
                              <span className="text-green-400 mr-3 text-lg">
                                +
                              </span>
                              <span className="text-sm sm:text-base">
                                Split any purchase into installments
                              </span>
                            </div>
                            <div className="flex items-center text-white">
                              <span className="text-green-400 mr-3 text-lg">
                      ...
                      <div className="space-y-8">
                        <ScrollBlurItem>
                          <div>
                            ...
                            <p className="text-white/80 text-base sm:text-lg leading-relaxed">
                              Offer your customers payment flexibility and get
                              paid the full amount upfront. Meqenet takes on all
                              the risk.
                            </p>
                          </div>
                        </ScrollBlurItem>
                        ...
                        <ScrollBlurItem>
                          <div className="space-y-3 sm:space-y-4">
                            ...
                            <div className="flex items-center text-white">
                              ...
                              <span className="text-sm sm:text-base">
                                Attract more customers and boost conversion
                              </span>
                            </div>
                            <div className="flex items-center text-white">
                              <span className="text-green-400 mr-3 text-lg">
                              ...
                              <span className="text-sm sm:text-base">
                                Zero fraud or credit risk for you
                              </span>
                            </div>
                          </div>
                        </ScrollBlurItem>
                      ...
                      <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light leading-relaxed">
                        <div className="text-left">
                          <span className="text-white">
                            Partner with Meqenet to offer flexible payments.
                          </span>
                          <span className="text-white/70">
                            {' '}
                            We provide seamless integration
                          </span>
                        </div>

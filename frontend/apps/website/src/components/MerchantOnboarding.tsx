      ...
      {isSuccess ? (
        <div className="text-center py-8">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Thank you for applying to become a FlexPay merchant. We will review
        ...
        <>
          <div className="mb-8">
            <div className="flex items-center">
              <div
                className={`flex-1 border-t-2 ${step >= 1 ? 'border-primary-500' : 'border-gray-200'}`}
              />
              <div
              ...
              <div
                className={`flex-1 border-t-2 ${step >= 2 ? 'border-primary-500' : 'border-gray-200'}`}
              />
              <div
                className={`w-8 h-8 flex items-center justify-center rounded-full ${
                  step >= 2
              ...
              <div
                className={`flex-1 border-t-2 ${step >= 3 ? 'border-primary-500' : 'border-gray-200'}`}
              />
              <div
                className={`w-8 h-8 flex items-center justify-center rounded-full ${
                  step >= 3
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    id="bankName"
                    name="bankName"
                    aria-labelledby="bankName-label"
                    className="w-full p-2 border border-gray-300 rounded-md"
                ...
                <div>
                  ...
                  <input
                    ...
                    aria-labelledby="bankAccountName-label"
                    className="w-full p-2 border border-gray-300 rounded-md"

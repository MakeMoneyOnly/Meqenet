      ...
      <div className="w-full max-w-7xl bg-black rounded-3xl flex flex-col lg:flex-row overflow-hidden shadow-2xl">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-gray-100 px-4 py-3 text-base outline-none"
                />
              </div>
              <div>
                <label
              ...
              <div>
                ...
                <textarea
                  ...
                  aria-label="Message"
                  className="w-full rounded-xl bg-gray-100 px-4 py-3 text-base outline-none min-h-[80px]"
                />
              </div>
              <button
                type="submit"
                className="w-full bg-black text-white rounded-full py-3 text-lg font-semibold mt-2 transition hover:bg-gray-900"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-10 text-white relative min-h-[600px]">
          <h1 className="text-6xl md:text-7xl font-bold mb-6">
            Let&apos;s grow<span className="text-white">.</span>
          </h1>
          <div className="text-2xl font-semibold mb-6 text-left w-full max-w-xl">
            Tell us about your business and how we can help you reach more
            customers.
          </div>
          ...
          <div className="flex flex-col md:flex-row w-full max-w-xl gap-10 mb-10">
            <div className="flex-1">
              ...
              <div className="text-sm text-gray-300">
                Our team will get you set up to accept Meqenet payments in no
                time.
              </div>
            </div>
            <div className="flex-1">
              ...
              <div className="text-sm text-gray-300">
                We provide a dedicated merchant success manager to help you
                grow.
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-8 right-8 bg-white rounded-2xl flex items-center shadow-lg p-4 min-w-[320px]">
            ...
            <div>
              ...
              <button className="mt-2 bg-black text-white rounded-full px-4 py-1 text-xs font-semibold flex items-center gap-2">
                Ask directly{' '}

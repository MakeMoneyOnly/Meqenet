...
const ServiceCard: React.FC<{
  ...
  <div
    className={`bg-white rounded-[16px] p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow ${className}`}
  >
...
const ServicesSection: React.FC = () => {
  return (
    <section
      data-scroll-section
      className="w-full py-20 px-4 sm:px-8 md:px-16 lg:px-24"
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-center font-aeonik text-base leading-relaxed">
            ...
            deserves the utmost attention. That&apos;s why Meqenet offers a
            suite of integrated services designed to make Buy Now, Pay Later
            simple, fair, and accessible for all Ethiopians.
          </p>
        </div>

...
import LogoCloud from './common/logo-cloud';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 mb-16 md:mb-32 lg:mb-48 items-start">
          ...
          <div className="lg:col-span-10">
            <div className="lg:pl-12" style={{ lineHeight: 1.05 }}>
              <ScrollBlurItem>
                <h2
                  className="text-black font-bold text-3xl sm:text-4xl md:text-5xl lg:text-[56px] mb-2"
              ...
              <ScrollBlurItem>
                <div
                  className="text-gray-400 font-normal text-3xl sm:text-4xl md:text-5xl lg:text-[56px]"
              ...
              <ScrollBlurItem>
                ...
                >
                  ...
                  <span style={{ color: 'rgba(0,0,0,0.4)' }}>
                    &nbsp;We provide seamless payment solutions that boost sales
                    for merchants and offer flexibility for shoppers, project
                    after project.
                  </span>
                </p>
              </ScrollBlurItem>
                ...
                <div className="flex flex-col gap-[5px]">
                  <div className="rounded-xl p-5 shadow-[0_5px_15px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.07)] transition-shadow duration-300 h-24 md:h-28">
                    <div className="flex justify-between items-center mb-1">
                      <ScrollBlurItem>
                        <div className="text-[40px] md:text-[48px] lg:text-[56px] font-bold text-black">
                          30%+
                        </div>
                      </ScrollBlurItem>
                      <ScrollBlurItem>
                    ...
                    <div className="mt-auto">
                      <ScrollBlurItem>
                        <div className="text-sm text-gray-600 text-right">
                          Our merchant partners see a significant boost in
                ...
                <div className="flex flex-col gap-[5px]">
                  ...
                  <div className="rounded-xl p-5 flex flex-col shadow-[0_5px_15px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.07)] transition-shadow duration-300 h-64 md:h-72">
                    ...
                    <div className="mt-auto">
                      <ScrollBlurItem>
                        <div className="text-sm text-gray-600 text-right">
                          Join a rapidly expanding community of savvy Ethiopian
                          shoppers enjoying payment flexibility.
                        </div>
                      </ScrollBlurItem>
                    </div>
                  </div>
...
export default function ClientsProjectsSection() {
  const waysToPay = [
    {
      title: 'At Checkout',
      imageSrc:
        'https://images.unsplash.com/photo-1589793463343-0a7c930a3b83?auto=format&fit=crop&w=800&q=60',
    ...
    },
    {
      ...
      imageSrc:
        'https://images.unsplash.com/photo-1601784551446-20c9e07cd66d?auto=format&fit=crop&w=800&q=60',
    ...
    },
    {
      ...
      imageSrc:
        'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?auto=format&fit=crop&w=800&q=60',
    ...
    },
    {
      ...
      imageSrc:
        'https://images.unsplash.com/photo-1556742502-ec7c0e2f3440?auto=format&fit=crop&w=800&q=60',
      imageAlt:
        'A physical credit card being used at a point-of-sale terminal.',
      linkText: 'Learn more',
    },
  ];
  ...
  const partnerLogos = [
    ...
    {
      name: 'Dashen Bank',
      path: '/partners/dashen.svg',
      width: 100,
      height: 28,
    },
    {
      name: 'Bank of Abyssinia',
      path: '/partners/abyssinia.svg',
      width: 100,
      height: 28,
    },
    {
      name: 'ShebaMiles',
      path: '/partners/shebamiles.svg',
      width: 100,
      height: 28,
    },
    {
      name: 'Ethiopian Airlines',
      path: '/partners/ethiopian.svg',
      width: 100,
      height: 28,
    },
  ];
            ...
            <div className="lg:absolute right-0 bottom-8 max-w-sm text-right mt-8 lg:mt-0">
              <ScrollBlurItem>
                <p className="text-sm leading-relaxed text-gray-500 font-light">
                  From your favorite local shops to major online stores, Meqenet
                  is your passport to flexible payments. Discover where you can
                  shop.
                </p>
              </ScrollBlurItem>
            </div>

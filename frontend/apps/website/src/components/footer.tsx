      ...
      <div className="w-full max-w-[1700px] mx-auto flex flex-row justify-between items-start px-12 pt-24 pb-0">
        ...
        <div className="flex flex-col items-start min-w-[320px]">
          ...
          <div className="flex items-center text-[32px] font-bold mb-2">
            ...
            <a href="mailto:hello@meqenet.com" className="underline decoration-2 underline-offset-4 hover:text-gray-700 transition-colors">hello@meqenet.com</a>
                    </div>
                </div>
        ...
        <div className="flex flex-col items-start min-w-[220px] ml-32">
          ...
          <ul className="space-y-1 text-[22px] font-medium">
            ...
            <li><a href="#merchants" className="hover:underline">Merchants</a></li>
        ...
        <div className="flex flex-col items-start min-w-[220px] ml-32">
          ...
          <ul className="space-y-1 text-[22px] font-medium">
            <li><a href="#" className="hover:underline flex items-center">Twitter <span className="ml-1 text-base">↗</span></a></li>
            <li><a href="#" className="hover:underline flex items-center">Instagram <span className="ml-1 text-base">↗</span></a></li>
            <li><a href="#" className="hover:underline flex items-center">Dribbble <span className="ml-1 text-base">↗</span></a></li>
          </ul>
                            </div>
                    </div>
      {/* Large fabrica® Studio Section - right aligned */}
      <div className="w-full flex flex-row justify-end items-center pr-24" style={{minHeight: '340px'}}>
        <div className="flex flex-col items-start">
          <span className="text-[180px] leading-[0.9] font-bold tracking-tight text-black select-none">meqenet<sup className="text-[60px] align-super">®</sup></span>

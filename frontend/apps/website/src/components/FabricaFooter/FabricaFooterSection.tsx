  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-between bg-[#f7f9f8]">
      ...
      <div className="w-full max-w-[1700px] mx-auto flex flex-row justify-between items-start pt-16 px-12">
        ...
        <div className="flex flex-col items-start min-w-[320px]">
          ...
          <div className="flex items-center text-[32px] font-bold mb-2">
            ...
            <a href="mailto:hello@fabrica.com" className="underline decoration-2 underline-offset-4 hover:text-gray-700 transition-colors">hello@fabrica.com</a>
          </div>
        </div>
        {/* Navigation (center) */}
        <div className="flex flex-row gap-32">
          ...
          <div className="min-w-[120px]">
            ...
            <ul className="space-y-1 text-lg font-medium">
              <li><a href="#" className="hover:underline flex items-center">Twitter <span className="ml-1">↗</span></a></li>
              <li><a href="#" className="hover:underline flex items-center">Instagram <span className="ml-1">↗</span></a></li>
              <li><a href="#" className="hover:underline flex items-center">Dribbble <span className="ml-1">↗</span></a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <span className="text-[160px] leading-[0.9] font-bold tracking-tight text-black select-none">fabrica<sup className="text-[60px] align-super">®</sup></span>
      ...
      <footer className="w-full bg-black text-white text-xs flex flex-row items-center justify-between px-12 py-3">
        ...
        <div className="flex flex-row gap-8">
          ...
          <span className="flex items-center gap-1"><svg width="16" height="16" fill="none" viewBox="0 0 24 24"><path d="M12 2v20M2 12h20" stroke="currentColor" strokeWidth="2"/></svg> Built in Framer</span>
        </div>
        <span>Created by <span className="font-semibold">Anatolii Dmtrienko</span></span>
        <button className="ml-4 bg-white text-black rounded-full px-4 py-1 text-xs font-semibold border border-black">Buy template</button>
        <button className="ml-2 bg-white text-black rounded-full px-4 py-1 text-xs font-semibold border border-black flex items-center gap-1">
          <svg width="16" height="16" fill="none" viewBox="0 0 24 24"><rect width="24" height="24" rx="6" fill="#000"/><path d="M7 12h10M12 7v10" stroke="#fff" strokeWidth="2"/></svg>
          Made in Framer
        </button>
      </footer>
    </div>

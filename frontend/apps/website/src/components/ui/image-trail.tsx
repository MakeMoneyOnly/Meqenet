...
class ImageTrailVariant1 {
  ...
  private boundHandlePointerMove: (_ev: MouseEvent | TouchEvent) => void;
  private boundInitRender: (_ev: MouseEvent | TouchEvent) => void;
  ...
  constructor(container: HTMLDivElement) {
    ...
    if (this.imagesTotal === 0) {
      ...
      this.boundHandlePointerMove = () => void 0;
      this.boundInitRender = () => void 0;
      this.boundRenderLoop = () => void 0;
      return;
    }
...
// Interface for ImageTrail variant classes
interface ImageTrailVariant {
  destroy(): void;
}

const _variantMap: {
  [key: number]: new (container: HTMLDivElement) => ImageTrailVariant;
} = {
...
export const ImageTrail: FC<ImageTrailProps> = ({
  ...
  useEffect(() => {
    ...
    const Cls = _variantMap[variant] || _variantMap[1];
    if (!Cls) {

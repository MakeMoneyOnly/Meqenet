...
const HeroSection: React.FC<HeroSectionProps> = ({ nextSectionRef, show = true }) => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-gray-50 to-white py-2 sm:py-3 md:py-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-[20%] right-[10%] w-64 h-64 bg-blue-50 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
        <div className="absolute bottom-[15%] left-[5%] w-72 h-72 bg-green-50 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
      </div>
        ...
        >
          ...
          >
            <div className="w-full flex flex-col items-center mt-[-40px]">
                ...
                >
                  ...
                  >
                    <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4 2L9 6.5L4 11" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </motion.span>
                </button>
              </motion.div>
              ...
              {/* Large Brand Name */}
              <motion.div variants={fadeInUp} className="mb-6 w-full flex justify-center">
                <h1 className="text-[80px] sm:text-[120px] md:text-[160px] lg:text-[220px] xl:text-[280px] 2xl:text-[340px] font-normal text-white leading-[0.8] tracking-[-0.08em] drop-shadow-xl text-center w-full flex items-center justify-center">
                  meqenet<span className="text-green-400 inline-flex items-center ml-[10px]">.</span>
                </h1>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="w-full flex justify-center mt-10">
                <h2 className="text-[22px] sm:text-[28px] md:text-[36px] lg:text-[44px] font-light text-white/90 leading-[1.2] drop-shadow-lg max-w-4xl text-center">
                  Choose to pay in 4 interest-free payments<br />in full, in 30 days, or over time.
                </h2>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <span className="text-white/80 text-xs sm:text-sm">Growing Fast</span>
            ...
            <div className="space-y-3">
              ...
              <div>
                <div className="text-white/60 text-xs mb-1">Partner Merchants</div>
                <div className="text-white text-xl sm:text-2xl font-bold">500+</div>
              </div>
              <div>
                <div className="text-white/60 text-xs mb-1">Customer Satisfaction</div>
                <div className="text-white text-xl sm:text-2xl font-bold">96%</div>
            </div>
          </div>
          </motion.div>
          ...
          >
            <span className="text-white/80 text-xs mb-2">Scroll to explore</span>

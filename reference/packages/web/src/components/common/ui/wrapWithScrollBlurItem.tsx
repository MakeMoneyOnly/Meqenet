...
const BLUR_TAGS = [
  ...
  "a", "button", "div", "section", "article", "nav", "aside", "main", 
  "time", "small", "strong", "em", "mark", "del", "ins", "sub", "sup"
];

// List of class substrings to exclude (e.g., cards) - reduced exclusions
const EXCLUDE_CLASSES = [
  "fixed", "absolute", "sticky", "z-50", "z-40", "backdrop", "overlay"
];
...
export function wrapWithScrollBlurItem(children: React.ReactNode): React.ReactNode {
  ...
  if (React.isValidElement<ElementProps>(children)) {
    ...
    const getComponentName = (type: string | React.JSXElementConstructor<unknown>): string => {

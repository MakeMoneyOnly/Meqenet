  ...
  const [services, setServices] = useState<ServiceCategory[]>([
    {
      ...
      description: "Get started in minutes. Our streamlined KYC process uses your Ethiopian ID for instant approval.",
      image: "https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?auto=format&fit=crop&w=800&q=60",
      isOpen: true
    },
    {
      id: "002",
      ...
      description: "Shop now and pay later with our 100% interest-free installment plans. Choose a schedule that works for you.",
      image: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=800&q=60",
      isOpen: false
    },
    {
      id: "003",
      ...
      image: "https://images.unsplash.com/photo-1580974918889-77a33a75225a?auto=format&fit=crop&w=800&q=60",
      isOpen: false
    },
    {
      id: "004",
      ...
      description: "Manage your payments easily through Telebirr, CBE Birr, and other local options. We'll send you reminders so you never miss a due date.",
      image: "https://images.unsplash.com/photo-1604940500624-a1c1dcec3c47?auto=format&fit=crop&w=800&q=60",
      isOpen: false
    }
  ]);
  ...
  return (
    <>
            ...
            <div className="w-[calc(100%-40px)] sm:w-[calc(100%-60px)] md:w-[calc(100%-80px)] max-w-[1500px] mx-auto py-8 sm:py-12 md:py-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 mb-6 sm:mb-8 items-start">
                ...
                <div className="lg:col-span-2 flex items-center mb-3 sm:mb-4 lg:mb-0">
                    ...
                    <ScrollBlurItem>
                      <span className="text-xs sm:text-sm font-bold text-white">What we do</span>
                    </ScrollBlurItem>
                </div>
                ...
                <div className="lg:col-span-10 lg:pl-12">
                  ...
                  <ScrollBlurItem>
                    <p className="text-xs sm:text-sm text-white/50 mt-1 sm:mt-2">©2024</p>
                  </ScrollBlurItem>
                </div>
              </div>
        ...
        <div className="w-[calc(100%-40px)] sm:w-[calc(100%-60px)] md:w-[calc(100%-80px)] max-w-[1500px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 mb-6 sm:mb-8 items-start">
            ...
            <div className="lg:col-span-2 flex items-center mb-3 sm:mb-4 lg:mb-0">
                ...
                <ScrollBlurItem>
                  <span className="text-xs sm:text-sm font-bold">Our Commitment</span>
                </ScrollBlurItem>
            </div>
            ...
            <div className="lg:col-span-10 lg:pl-12">
              <ScrollBlurItem>
                <p className="text-base sm:text-lg font-bold mb-6 sm:mb-8">meqenet<sup>®</sup></p>
              </ScrollBlurItem>
          
              {/* Main heading - consistent with Services */}
              <ScrollBlurItem>
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
              <span className="text-black">A transparent and fair financial</span><br />
              <span className="text-gray-400">partner for all Ethiopians.</span>
            </h2>
              </ScrollBlurItem>
            
            <ScrollBlurItem>
              <p className="text-gray-600 font-bold max-w-xs sm:max-w-sm md:max-w-md text-sm sm:text-base mb-4">
                We combine secure technology and user-centric design to build financial tools that empower our communities.
            </p>
            </ScrollBlurItem>
            </div>
          </div>
      ...
      <section className="pb-3 sm:pb-4 -mt-4 sm:-mt-5 md:-mt-6">
        <div className="w-[calc(100%-40px)] sm:w-[calc(100%-60px)] md:w-[calc(100%-80px)] max-w-[1500px] mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4" style={{ transform: "translateY(-5px)" }}>
            {/* Card 1 */}
            <ScrollBlurItem>
              ...
              <div className="flex items-center mb-2 sm:mb-3">
                <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-white rounded-full mr-1"></div>
                <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-gray-600 mr-1"></div>
                <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-gray-600 mr-1"></div>
                <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-gray-600"></div>
                <span className="ml-auto text-gray-400 text-xs sm:text-sm">01</span>
              </div>
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  <h3 className="text-sm sm:text-base font-bold">Financial Inclusion</h3>
                  <p className="text-xs sm:text-sm text-white/80">Fair access for all Ethiopians.</p>
                </div>
              </div>
            </div>
            </ScrollBlurItem>
            ...
            <div className="bg-black text-white p-5 rounded-xl shadow-md h-auto sm:h-[160px] lg:h-[160px] opacity-90 hover:opacity-100 transition-opacity">
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs sm:text-sm text-white/80">Ethical, interest-free financing.</p>
                </div>
              </div>
            </div>
            </ScrollBlurItem>
            ...
            <div className="bg-black text-white p-5 rounded-xl shadow-md h-auto sm:h-[160px] lg:h-[160px] opacity-90 hover:opacity-100 transition-opacity">
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">Boost sales and gain customers.</p>
                </div>
              </div>
            </div>
            </ScrollBlurItem>
            ...
            <div className="bg-black text-white p-5 rounded-xl shadow-md h-auto sm:h-[160px] lg:h-[160px] opacity-90 hover:opacity-100 transition-opacity">
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">Your data and funds are safe.</p>
                </div>
              </div>
            </div>
            </ScrollBlurItem>
          ...
          <ScrollBlurItem>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <div className="transform group-hover:opacity-0 group-hover:translate-y-4 transition-all duration-500 ease-in-out">
                <h3 className="text-white text-lg sm:text-xl md:text-2xl font-bold text-center">Watch showreel</h3>
                <p className="text-white/70 text-xs sm:text-sm font-bold text-center">(2016-25©)</p>
              </div>
            </div>
          </div>
          </ScrollBlurItem>
        ...
        <div className="w-[calc(100%-40px)] sm:w-[calc(100%-60px)] md:w-[calc(100%-80px)] max-w-[1500px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 mb-8 sm:mb-10 items-start">
            <div className="lg:col-span-2 flex items-center mb-3 sm:mb-4 lg:mb-0">
              ...
              <ScrollBlurItem>
                <span className="text-xs sm:text-sm font-bold">Testimonials</span>
              </ScrollBlurItem>
            </div>
            <div className="lg:col-span-10 lg:pl-12">
              <ScrollBlurItem>
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
                  <span className="text-black">Voices from Our</span><br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {/* Testimonial 1: Shopper */}
              ...
              <div className="p-6 sm:p-8 border border-gray-200 rounded-3xl">
                <p className="text-base sm:text-lg font-medium mb-4">
                  &quot;Finally, a way to buy what I need for my family without the stress of interest. Meqenet was so easy to set up and use. I bought a new refrigerator and paid for it over three months, which was a huge help for my budget.&quot;
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Shopper, Addis Ababa</p>
                  </div>
                </div>
              </div>
              </ScrollBlurItem>
            ...
            {/* Testimonial 2: Merchant */}
              ...
              <div className="p-6 sm:p-8 border border-gray-200 rounded-3xl">
                <p className="text-base sm:text-lg font-medium mb-4">
                  &quot;Integrating Meqenet at my electronics shop was the best decision I made this year. My sales have increased by over 30%, and I get my settlements instantly. It brings in customers who might not have made a purchase otherwise.&quot;
                </p>
                <div className="flex items-center">
                    <Image 
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Owner, Dani Electronics</p>
                  </div>
                </div>
              </div>
              </ScrollBlurItem>
        ...
        <div className="w-[calc(100%-40px)] sm:w-[calc(100%-60px)] md:w-[calc(100%-80px)] max-w-[1500px] mx-auto">
          ...
          <div className="lg:pl-32">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-8 gap-y-10 items-center">
                ...
                <Image src="/assets/images/partners/telebirr.svg" alt="Telebirr" width={140} height={40} className="opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition" />
                <Image src="/assets/images/partners/cbe.svg" alt="CBE Birr" width={140} height={40} className="opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition" />
                <Image src="/assets/images/partners/ethio-telecom.svg" alt="Ethio Telecom" width={140} height={40} className="opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition" />
                <Image src="/assets/images/partners/boa.svg" alt="Bank of Abyssinia" width={140} height={40} className="opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition" />
                <Image src="/assets/images/partners/dashen.svg" alt="Dashen Bank" width={140} height={40} className="opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition" />
              </div>
                </ScrollBlurItem>
          </div>
        </div>
        ...
        <div className="w-[calc(100%-40px)] sm:w-[calc(100%-60px)] md:w-[calc(100%-80px)] max-w-[1500px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 mb-6 sm:mb-8 items-start">
            <div className="lg:col-span-2 flex items-center mb-3 sm:mb-4 lg:mb-0">
                ...
                <ScrollBlurItem>
                  <span className="text-xs sm:text-sm font-bold">How it Works</span>
              </ScrollBlurItem>
            </div>
            <div className="lg:col-span-10 lg:pl-12">
              <ScrollBlurItem>
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
                  <span className="text-black">See Meqenet in</span><br />
                  <span className="text-gray-400">Action.</span>
                </h2>
              </ScrollBlurItem>
              <ScrollBlurItem>
                <p className="text-gray-600 font-bold max-w-xs sm:max-w-sm md:max-w-md text-sm sm:text-base">
                  Watch a short demo to see how simple it is to shop and pay with Meqenet.
                </p>
              </ScrollBlurItem>
            </div>
          </div>

  ...
  const articles = [
    {
      ...
      description: 'How digital storefronts and online payments are changing the way Ethiopians shop.',
    ...
    },
    {
      ...
      description: 'Buy Now, Pay Later is providing accessible credit to millions of consumers.',
    ...
    <section className="relative py-16 sm:py-20 md:py-24 lg:py-28 bg-gray-50 overflow-hidden">
      <div className="relative z-10 w-[calc(100%-20px)] sm:w-[calc(100%-40px)] md:w-[calc(100%-60px)] max-w-[1520px] mx-auto">
        <div className="flex flex-row justify-between mb-10 md:mb-14 w-full">
          <div className="max-w-2xl flex flex-col justify-end h-full" style={{minHeight: '80px'}}>
            <ScrollBlurItem>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-tight">
                <span>Shaping the future of</span><br />
            ...
            <ScrollBlurItem>
              <div className="flex items-center">
                <p className="text-sm text-gray-600 mr-[500px] whitespace-nowrap">
                  Stay informed about the future of finance and<br className="hidden sm:block"/> technology in Ethiopia.
                </p>
                <Link href="#" className="inline-flex items-center justify-center rounded-full bg-black text-white px-6 py-2 text-sm font-medium">
                  Learn More
                  <svg className="ml-2 h-4 w-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="12" cy="12" r="12" fill="white" fillOpacity="0.2"/>
                    <path d="M10.75 8.75L14.25 12L10.75 15.25" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </Link>
              </div>
            </ScrollBlurItem>
            ...
            <ScrollBlurItem>
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div style={{ width: IMAGE_SIZE, height: IMAGE_SIZE }} className="rounded-xl overflow-hidden bg-gray-100 flex-shrink-0">
                    <Image 
                  ...
                  <div
                    ...
                    style={{ width: ICON_SIZE, height: ICON_SIZE, borderRadius: ICON_SIZE / 2, background: '#000' }}
                  >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{articles[0].description}</p>
                </div>
              </div>
            </ScrollBlurItem>
          </div>
          ...
          <div className="col-span-12 md:col-span-4 lg:col-span-3">
            <ScrollBlurItem>
              ...
              >
                ...
                {/* Bottom content */}
                <div>
                  <p className="text-sm text-gray-500 mb-2">{articles[1].date}</p>
                  <h3 className="text-xl font-bold mb-2">{articles[1].title}</h3>
                ...
                <div className="h-full relative overflow-hidden flex flex-col min-h-0">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex flex-col justify-end p-6">
                    <div className="absolute top-4 left-6">
                      <span className="text-white text-sm font-medium">meqenet®</span>
                    </div>
                    <div className="absolute top-4 right-4" style={{width: `${FEATURED_ICON_SIZE}px`, height: `${FEATURED_ICON_SIZE}px`, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 0V12" stroke="white" strokeWidth="2"/>
                        <path d="M0 6H12" stroke="white" strokeWidth="2"/>
                      </svg>

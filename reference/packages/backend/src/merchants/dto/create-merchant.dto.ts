...
export class CreateMerchantDto {
  @ApiProperty({ example: 'Abyssinia Electronics', description: 'Merchant business name' })
  @IsString()
  @IsNotEmpty()
  name: string;
  ...
  @ApiProperty({ example: 'Abebe Kebede', description: 'Name of contact person' })
  @IsString()
  @IsNotEmpty()
  contactPerson: string;

  @ApiProperty({ example: 'contact@abyssiniaelectronics.et', description: 'Business email address' })
  @IsEmail()
  @IsNotEmpty()
  email: string;

  @ApiProperty({ example: '+251912345678', description: 'Business phone number' })
  @IsString()
  @IsNotEmpty()
  @Matches(/^\+251[7-9]\d{8}$/, { 

...
The Auth Service implements bilingual error handling to comply with Ethiopian National Bank (NBE) consumer protection directives. All error messages are provided in both English and Amharic (አማርኛ).
...
1. **NBE Directive No. FIS/02/2021**: Requires financial services to provide information in local languages
